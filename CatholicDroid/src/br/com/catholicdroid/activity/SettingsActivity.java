 ...
 * single list. On tablets, settings are split by category, with category headers shown to the left of the list of settings.
 * <p>
...
public class SettingsActivity extends SherlockPreferenceActivity {
     ...
     * {@link #ALWAYS_SIMPLE_PREFS}, or the device doesn't have newer APIs like {@link PreferenceFragment}, or the device
    ...
    /**
     * Binds a preference's summary to its value. More specifically, when the preference's value is changed, its summary (line
     * of text below the preference title) is updated to reflect the value. The summary is also immediately updated upon calling
     * this method. The exact display format is dependent on the type of preference.
     * 
